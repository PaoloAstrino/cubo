...
> Canonical source of truth for evaluation results. See also `docs/eval/per_domain_breakdown.md`, `docs/eval/PR_SUMMARY.md`, `docs/eval/table9_reranker_effect.md`, and `docs/eval/system_metrics_summary.md`.
...
| arguana | argument | small | 1,406 | 0.8962 | 0.3311 | ⭐ Excellent (dense topk50) |
| nfcorpus | medical | small | 323 | 0.1697 | 0.3195 | ❌ Poor |
| ultradomain_medium | cross-domain | medium | 1,268 | 0.8265 | 0.6659 | 🚀 Exceptional |
| ultradomain_legal | legal | medium | 438 | 0.4772 | 0.2308 | ⭐ Good |
| ultradomain_politics | politics | medium | 180 | 0.9667 | 0.7435 | 🚀 Perfect |
| ultradomain_agriculture | agriculture | small | 100 | 1.0000 | 0.7018 | 🚀 Perfect |
| ragbench_merged | mixed-rag | medium | 4,737 | 0.4146 | 0.5324 | ⭐ Strong (Merged set) |
