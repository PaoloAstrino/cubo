...
class ScaffoldRetriever:
    ...
    def retrieve_scaffolds(
        self, query: str, top_k: int = 5, expand_to_chunks: bool = True
    ) -> List[Dict[str, Any]]:
        """
    ...
    def load_scaffold_index(self, scaffold_dir: Path, use_faiss: bool = True) -> bool:
        """
...
def create_scaffold_retriever_from_directory(
    scaffold_dir: str, embedding_generator: Optional[Any] = None
) -> ScaffoldRetriever:
    """
