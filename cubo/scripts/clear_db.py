...
def parse_args():
    ...
    parser.add_argument(
        "--wipe-storage", action="store_true", help="Remove on-disk storage after reset"
    )
...
def main():
    ...
    store = create_vector_store(collection_name=args.collection, index_dir=args.index_dir)
