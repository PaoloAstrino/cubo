...
class DocumentAlreadyExistsError(DatabaseError):
    ...
    def __init__(self, filename: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            f"Document '{filename}' already exists in the database", "DOC_EXISTS", details
        )
...
class DocumentNotFoundError(DatabaseError):
    ...
    def __init__(self, document_id: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(f"Document '{document_id}' not found", "DOC_NOT_FOUND", details)
...
class EmbeddingGenerationError(EmbeddingError):
    ...
    def __init__(self, text_preview: str, details: Optional[Dict[str, Any]] = None):
        ...
        super().__init__(
            f"Failed to generate embeddings for text: '{preview}'", "EMBEDDING_FAILED", details
        )
...
class ModelNotAvailableError(ModelLoadError):
    ...
    def __init__(self, model_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(f"Model '{model_name}' is not available", "MODEL_UNAVAILABLE", details)
...
class InvalidConfigurationError(ConfigurationError):
    ...
    def __init__(
        self, config_key: str, value: Any, expected: str, details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
...
class RetrievalMethodUnavailableError(RetrievalError):
    ...
    def __init__(self, method: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            f"Retrieval method '{method}' is not available", "METHOD_UNAVAILABLE", details
        )
...
class FileAccessError(FileOperationError):
    ...
    def __init__(self, filepath: str, operation: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(f"Failed to {operation} file '{filepath}'", "FILE_ACCESS_ERROR", details)
...
class ServiceTimeoutError(ServiceError):
    ...
    def __init__(
        self, service_name: str, timeout_seconds: float, details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
