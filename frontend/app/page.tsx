    ...
    return (
        <div className="flex flex-1 flex-col md:flex-row gap-6 h-[calc(100vh-6rem)] p-4 md:p-8">
            <Link href="/upload" className="flex-1 group">
                <Card className="h-full flex flex-col items-center justify-center text-center transition-all hover:border-primary hover:shadow-lg cursor-pointer group-hover:scale-[1.01]">
                    <CardHeader>
