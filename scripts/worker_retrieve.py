...
Usage: python scripts/worker_retrieve.py --index-dir results/beir_index_nfcorpus --queries data/beir/nfcorpus/queries.jsonl --output results/run_nfcorpus.json --top-k 50 --mode with_rerank|no_rerank
"""
import argparse
import json
import time
