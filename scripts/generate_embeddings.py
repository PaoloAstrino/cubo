...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate embeddings for chunk parquet and save as .npy')
...
def main():
    ...
    try:
        ...
        logger.warning('EmbeddingGenerator unavailable or load failed, falling back to lightweight embedder: %s', e)
