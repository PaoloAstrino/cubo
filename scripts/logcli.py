...
def query_index(db_path: Path, query: str, level: str = None, component: str = None, limit: int = 50):
...
def main():
    ...
    query_index(Path(args.db), args.query, level=args.level, component=args.component, limit=args.limit)
