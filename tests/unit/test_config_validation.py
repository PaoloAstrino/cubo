...
class TestConfigLoading:
    ...
    def test_config_default_values(self):
        ...
        minimal_config = {"embedding_model": "BAAI/bge-base-en-v1.5"}
...
class TestConfigPathResolution:
    ...
    def test_config_file_discovery(self):
        ...
        search_paths = ["configs/config_local.json", "cubo/config.json", "config.json"]
...
class TestConfigErrorHandling:
    ...
    def test_config_schema_mismatch(self):
        ...
        wrong_schema = {"unknown_field": "value", "another_unknown": 123}
...
class TestConfigMerging:
    ...
    def test_config_deep_merge(self):
        ...
        base_config = {"retrieval": {"top_k": 50, "use_reranker": True}}

        override_config = {"retrieval": {"top_k": 100}}  # Override only this
