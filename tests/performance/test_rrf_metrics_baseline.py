...
class TestRRFMetricsBaseline:
    ...
    def baseline_metrics(self):
        ...
        return {
            "nfcorpus": {"recall@10": 0.3106, "mrr": 0.2834, "ndcg@10": 0.2646},
            "scifact": {"recall@10": 0.6700, "mrr": 0.5890, "ndcg@10": 0.6120},
            "arguana": {"recall@10": 0.9870, "mrr": 0.9660, "ndcg@10": 0.9740},
            "fiqa": {"recall@10": 0.4010, "mrr": 0.3410, "ndcg@10": 0.3520},
        }
...
class TestRRFMetricsAggregation:
    ...
    def test_weighted_average_by_query_count(self):
        ...
        weighted_avg = sum(
            d["recall@10"] * d["num_queries"] / total_queries for d in dataset_metrics
        )
    ...
    def test_best_overall_config_selection(self):
        ...
        config_results = {
            "k60_sw1.0_bw1.0": {"avg_recall@10": 0.5921, "avg_mrr": 0.5448},
            "k20_sw1.0_bw1.0": {"avg_recall@10": 0.5800, "avg_mrr": 0.5350},
        }
