...
def sample_corpus():
    ...
    return [
        ...
        {"_id": "doc3", "text": "Natural language processing enables computers to understand text."},
        {"_id": "doc4", "text": "Computer vision allows machines to interpret visual information."},
        {"_id": "doc5", "text": "Reinforcement learning trains agents through rewards and penalties."}
    ]
