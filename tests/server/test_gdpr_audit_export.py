...
class TestGDPRAuditExportEdgeCases:
    ...
    def test_export_audit_malformed_json_lines(self, tmp_path):
        ...
        with open(log_file, "w") as f:
            f.write(
                '{"asctime": "2024-11-30 10:00:00,000", "levelname": "INFO", "name": "test", "message": "valid", "trace_id": ""}\n'
            )
            f.write("this is not valid json\n")
            f.write(
                '{"asctime": "2024-11-30 11:00:00,000", "levelname": "INFO", "name": "test", "message": "also valid", "trace_id": ""}\n'
            )
