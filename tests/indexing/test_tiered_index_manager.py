...
class TestTieredIndexManagerBuild:
    ...
    def test_build_faiss_index_updates_state(self):
        ...
        with patch.object(TieredIndexManager, 'faiss_manager', new_callable=PropertyMock) as mock_prop:
...
class TestTieredIndexManagerBuildAll:
    ...
    def test_build_all_calls_both_builds(self):
        ...
        with patch.object(TieredIndexManager, 'faiss_manager', new_callable=PropertyMock) as mock_faiss_prop:
            with patch.object(TieredIndexManager, 'bm25_store', new_callable=PropertyMock) as mock_bm25_prop:
