...
def test_ragas_smoke_cli(monkeypatch, tmp_path):
    ...
    def _load_test_queries(name, n):
        return [
            {"question": "What is GDPR Article 5?", "ground_truth": "Principles for processing personal data.", "query_id": "q1"},
            {"question": "What is the role of the European Parliament?", "ground_truth": "Legislative body of the EU.", "query_id": "q2"},
        ]
    ...
    def _fake_run_ragas_evaluation(questions, contexts, ground_truths, answers, llm=None, max_workers=None, save_per_sample_path=None, retrieval_times=None, generation_times=None):
    ...
    sys_argv = ["run_generation_eval.py", "--dataset", "politics", "--num-samples", "2", "--output", str(out_dir), "--judge", "local"]
