...
class TestMultilingualTokenizer:
    ...
    def test_auto_language_tokenization(self):
        ...
        # Italian text
        tokens_it = tokenizer.tokenize("I gatti mangiano il pesce", language="auto")
        assert len(tokens_it) > 0

        # French text
        tokens_fr = tokenizer.tokenize("Le développement du logiciel", language="auto")
    ...
    def test_batch_tokenization(self):
        ...
        texts = ["il gatto", "le chat", "die Katze"]
