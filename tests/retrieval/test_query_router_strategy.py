from src.cubo.routing.query_router import QueryRouter, RetrievalStrategy, QueryType
...
def test_compute_strategy_matches_config():
    ...
    for qtype_name, preset in presets.items():
        ...
        assert 'label' in strategy.classification and 'confidence' in strategy.classification and 'fallback_used' in strategy.classification
