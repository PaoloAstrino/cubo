...
def test_file(tmp_path):
    ...
    d.write_text(
        "This is an end-to-end test document for CUBO. It verifies that the upload and RAG pipeline are working correctly."
    )
    return str(d)
...
class TestFullAppFlow:
    ...
    def test_upload_and_chat_flow(self, page, base_url, test_file):
        ...
        assert upload_page.is_file_uploaded_success(
            timeout=120000
