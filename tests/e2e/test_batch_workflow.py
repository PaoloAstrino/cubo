...
class TestBatchWorkflow:
    ...
    def test_batch_output_naming_convention(self):
        ...
        expected_outputs = [
            output_template.format(dataset=ds) for ds in datasets
        ]
...
class TestBatchIndexManagement:
    ...
    def test_batch_with_existing_indexes(self):
        ...
        index_dirs = [
            "results/beir_index_nfcorpus",
            "results/beir_index_scifact"
        ]
...
class TestBatchLogging:
    ...
    def test_batch_log_per_dataset(self, tmp_path):
        ...
        expected_logs = [
            log_dir / f"beir_adapter_beir_run_{ds}_20260113_120000.log"
            for ds in datasets
        ]
...
class TestBatchConfigIntegration:
    ...
    def test_batch_cli_args_override_config(self):
        ...
        # Merged config
        final_config = {
            "datasets": cli_datasets,  # CLI overrides
            "laptop_mode": cli_laptop_mode
        }
