...
class TestCreateEmbeddingStore(unittest.TestCase):
    ...
    def test_create_memory_store(self):
        ...
        from src.cubo.storage.embedding_store import create_embedding_store, InMemoryEmbeddingStore
    ...
    def test_create_sharded_store(self):
        ...
        from src.cubo.storage.embedding_store import create_embedding_store, ShardedEmbeddingStore
    ...
    def test_create_mmap_store(self):
        ...
        from src.cubo.storage.embedding_store import create_embedding_store, MmapEmbeddingStore
...
class TestMmapEmbeddingStore(unittest.TestCase):
    ...
    def test_basic_operations(self):
        ...
        store = MmapEmbeddingStore(
            storage_path=Path(self.temp_dir) / 'embeddings.mmap',
            dimension=4,
            max_embeddings=100
        )
