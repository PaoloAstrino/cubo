    ...
    try:
        ...
        try:
            ...
            ndcg, _map, recall, precision = evaluator.evaluate(
                qrels, results, [10, 100], ignore_identical_ids=True
            )
...
def run_dense_beir(
    dataset: str, dataset_path: str, model_name: str = "sentence-transformers/e5-base-v2"
) -> Dict:
    ...
    try:
        ...
        query_embeddings = model.encode(
            list(queries.values()), show_progress_bar=True, batch_size=32
        )
...
def main():
    ...
    parser.add_argument(
        "--datasets", nargs="+", default=["scifact", "fiqa"], help="Datasets to evaluate"
    )
    parser.add_argument(
        "--output", default="results/baseline_ndcg_summary.json", help="Output file"
    )
