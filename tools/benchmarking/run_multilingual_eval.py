...
def main():
    ...
    parser.add_argument(
        "--use-compound-splitter", action="store_true", help="Enable German compound word splitting"
    )
    ...
    results = run_multilingual_eval(
        args.dataset, args.queries, args.index_dir, args.use_compound_splitter, args.top_k
    )
