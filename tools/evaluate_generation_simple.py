...
def load_test_queries(dataset_name: str, num_samples: int = 10) -> List[Dict[str, Any]]:
    ...
    queries = {
        "politics": [
            {"question": "What are the three main institutions of the European Union?", "answer": "The European Parliament, the Council of the European Union, and the European Commission."},
            {"question": "How often are European Parliament elections held?", "answer": "Every five years."},
            {"question": "What is the role of the European Commission?", "answer": "It proposes new laws, manages EU policies, and allocates EU funding."},
            {"question": "Which body represents the governments of EU member states?", "answer": "The Council of the European Union."},
            {"question": "What is the European Single Market?", "answer": "An area where goods, services, capital, and people can move freely."}
        ],
        "legal": [
            {"question": "What is the purpose of GDPR Article 5?", "answer": "It outlines the principles relating to the processing of personal data."},
            {"question": "What are the common legal grounds for processing personal data under GDPR?", "answer": "Consent, contract, legal obligation, vital interests, public task, and legitimate interests."},
            {"question": "What is a Data Processing Agreement (DPA)?", "answer": "A contract between a data controller and a data processor."},
            {"question": "What constitutes a personal data breach under GDPR?", "answer": "A breach of security leading to accidental or unlawful destruction, loss, alteration, or unauthorized disclosure of personal data."},
            {"question": "What is the 'Right to be Forgotten'?", "answer": "The right of data subjects to have their personal data erased under certain conditions."}
        ]
    }
...
def main():
    ...
    for i, q in enumerate(queries):
        ...
        logger.info(f"  Scores: Faithfulness={scores.get('faithfulness')}, Relevancy={scores.get('relevancy')}")
    ...
    with open(output_path, "w") as f:
        json.dump({"avg_faithfulness": avg_f, "avg_relevancy": avg_r, "details": results}, f, indent=2)
