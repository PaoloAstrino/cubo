...
def verify_dense_skip():
    ...
    retriever.executor.inference_threading.generate_embeddings_threaded.return_value = [np.zeros(384)]
    
    # Mock collection query to return empty
    retriever.collection.query = MagicMock(return_value={"documents": [], "metadatas": [], "distances": []})
