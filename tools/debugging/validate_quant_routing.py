...
print(
    f"Measured quantization degradation: {measured_degradation:.4f} ({measured_degradation*100:.2f}%)"
)
...
print(
    f"  Δ:            {alpha_static - alpha_adaptive:.4f} (reduced by {(1-alpha_adaptive/alpha_static)*100:.2f}%)"
)
...
print(
    f"  - Adaptive routing compensates by favoring BM25 by {(1-alpha_adaptive/alpha_static)*100:.2f}%"
)
