...
def encode_embeddings(texts: List[str], batch_size: int = 64, max_memory_gb: float = 14.0) -> np.ndarray:
...
def build_ivfpq_index(embeddings: np.ndarray, output_dir: Path, nlist: int = 256, nbits: int = 8) -> bool:
