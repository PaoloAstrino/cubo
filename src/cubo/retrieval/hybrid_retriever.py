...
warnings.warn(
    "src.cubo.retrieval.hybrid_retriever is deprecated; import HybridRetriever from src.cubo.retrieval.retriever instead.",
    DeprecationWarning,
    stacklevel=2,
)

from src.cubo.retrieval.retriever import HybridRetriever  # re-export canonical implementation
